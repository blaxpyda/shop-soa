...
const (
	...
	PaymentService_ConfirmPayment_FullMethodName   = "/grocery.payment.PaymentService/ConfirmPayment"
	PaymentService_GetPaymentStatus_FullMethodName = "/grocery.payment.PaymentService/GetPaymentStatus"
	PaymentService_RefundPayment_FullMethodName    = "/grocery.payment.PaymentService/RefundPayment"
	PaymentService_ListPayments_FullMethodName     = "/grocery.payment.PaymentService/ListPayments"
)
...
type PaymentServiceClient interface {
	...
	GetPaymentStatus(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
...
func (c *paymentServiceClient) InitiatePayment(ctx context.Context, in *InitiatePaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
...
func (c *paymentServiceClient) ConfirmPayment(ctx context.Context, in *ConfirmPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentResponse)
...
func (c *paymentServiceClient) GetPaymentStatus(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentResponse)
...
type PaymentServiceServer interface {
	...
	GetPaymentStatus(context.Context, *GetPaymentRequest) (*PaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) InitiatePayment(context.Context, *InitiatePaymentRequest) (*PaymentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InitiatePayment not implemented")
}
func (UnimplementedPaymentServiceServer) ConfirmPayment(context.Context, *ConfirmPaymentRequest) (*PaymentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfirmPayment not implemented")
}
func (UnimplementedPaymentServiceServer) GetPaymentStatus(context.Context, *GetPaymentRequest) (*PaymentResponse, error) {
...
func _PaymentService_GetPaymentStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPaymentStatus(ctx, req.(*GetPaymentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "payments/proto/payments.proto",
}
