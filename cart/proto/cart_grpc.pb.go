...
const (
	CartService_GetCart_FullMethodName        = "/grocery.cart.CartService/GetCart"
	CartService_AddToCart_FullMethodName      = "/grocery.cart.CartService/AddToCart"
	CartService_RemoveFromCart_FullMethodName = "/grocery.cart.CartService/RemoveFromCart"
	CartService_ClearCart_FullMethodName      = "/grocery.cart.CartService/ClearCart"
)
...
type CartServiceClient interface {
	...
	ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
}
...
func (c *cartServiceClient) ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CartServiceServer interface {
	...
	ClearCart(context.Context, *ClearCartRequest) (*EmptyResponse, error)
...
func (UnimplementedCartServiceServer) ClearCart(context.Context, *ClearCartRequest) (*EmptyResponse, error) {
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grocery.cart.CartService",
	...
	Metadata: "cart/proto/cart.proto",
}
