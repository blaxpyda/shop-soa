...
import (
	...
	"gorm.io/gorm"
	"thugcorp.io/grocery/order/config"
	"thugcorp.io/grocery/order/internal"
...
func main() {
	...
	repo := internal.NewOrderRepository(db)
	svc := internal.NewOrderService(repo)
	handler := internal.NewOrderHandler(svc)
