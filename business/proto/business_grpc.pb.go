...
const (
	BusinessService_CreateBusiness_FullMethodName = "/grocery.business.BusinessService/CreateBusiness"
	BusinessService_GetBusiness_FullMethodName    = "/grocery.business.BusinessService/GetBusiness"
	BusinessService_UpdateBusiness_FullMethodName = "/grocery.business.BusinessService/UpdateBusiness"
	BusinessService_DeleteBusiness_FullMethodName = "/grocery.business.BusinessService/DeleteBusiness"
)
...
func (c *businessServiceClient) CreateBusiness(ctx context.Context, in *CreateBusinessRequest, opts ...grpc.CallOption) (*Business, error) {
...
func (c *businessServiceClient) DeleteBusiness(ctx context.Context, in *DeleteBusinessRequest, opts ...grpc.CallOption) (*DeleteBusinessResponse, error) {
	...
	err := c.cc.Invoke(ctx, BusinessService_DeleteBusiness_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBusinessServiceServer) CreateBusiness(context.Context, *CreateBusinessRequest) (*Business, error) {
...
func (UnimplementedBusinessServiceServer) DeleteBusiness(context.Context, *DeleteBusinessRequest) (*DeleteBusinessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteBusiness not implemented")
}
...
var BusinessService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grocery.business.BusinessService",
	...
	Metadata: "business/proto/business.proto",
}
