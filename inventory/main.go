...
import (
	...
	"gorm.io/gorm"
	"thugcorp.io/grocery/inventory/config"
	"thugcorp.io/grocery/inventory/internal"
	"thugcorp.io/grocery/inventory/internal/domain"
	"thugcorp.io/grocery/inventory/internal/middleware"
...
func main() {
	...
	repo := internal.NewInventoryRepository(db)
	svc := internal.NewInventoryService(repo)
	handler := internal.NewInventoryHandler(svc)
